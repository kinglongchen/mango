package com.kinglong.mango.core.register.zookeeper;
...
import com.kinglong.mango.core.register.serializer.DefaultSerializer;
...
public class ZkRegister implements Register {
    ...
    public ZkRegister(String address,
                      ...
                      int sessionTimeout,
                      int connectionTimeout) {
        this(address,port, sessionTimeout, connectionTimeout, new DefaultSerializer());
    }
